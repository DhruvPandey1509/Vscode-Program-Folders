/*
Chef has an array consisting of N+K−1 integers. The array contains only the first N positive odd numbers.
...
For example, for N=3, K=2, the possible arrays could be [1,1,3,5], [3,1,3,5], [5,3,5,1]. For N=1, K=3,
there is only one possible array: [1,1,1].
